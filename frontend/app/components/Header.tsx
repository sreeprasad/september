      ...
      <div className="w-full max-w-3xl bg-[#0B0C15]/60 backdrop-blur-2xl border border-white/10 rounded-full shadow-2xl shadow-black/50 p-1.5 pl-4 pr-2 flex items-center justify-between transition-all hover:bg-[#0B0C15]/70 hover:border-white/15">
        ...
        <div className="flex items-center gap-3">
          <Link href="/" className="flex items-center gap-3 group">
            <div className="relative flex items-center justify-center w-9 h-9 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 shadow-lg shadow-indigo-500/20 text-white border border-white/10 overflow-hidden group-hover:scale-105 transition-transform">
              <div className="absolute inset-0 bg-white/20 opacity-0 group-hover:opacity-100 transition-opacity"></div>
              {/* Using a simple circle or custom SVG if no icon available, defaulting to Lucide Hub if needed, but keeping it abstract */}
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="relative z-10" aria-hidden="true">
                ...
                <path d="M5 7 12 12 19 7" />
                <path d="M12 12V21" />
              </svg>
            </div>
            <div className="flex flex-col">
              <span className="text-sm font-bold tracking-wider text-white leading-none font-sans group-hover:text-indigo-200 transition-colors">
                BRIEFME
              </span>
        ...
        <div className="flex items-center gap-1">
           <button className="w-9 h-9 flex items-center justify-center rounded-full text-slate-400 hover:text-white hover:bg-white/5 transition-all relative" aria-label="Notifications">
              <Bell size={20} />
              <span className="absolute top-2.5 right-2.5 w-1.5 h-1.5 bg-red-500 rounded-full border border-[#0B0C15]"></span>
           </button>
           
           <div className="h-4 w-px bg-white/10 mx-1 hidden sm:block" aria-hidden="true"></div>
           
           <button className="flex items-center gap-2 pl-1 pr-1 rounded-full hover:bg-white/5 transition-all group" aria-label="User Profile">
