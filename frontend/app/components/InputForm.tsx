...
import { Link, AtSign, ArrowRight, Loader2, ChevronsUpDown } from 'lucide-react';
...
export const InputForm: React.FC<InputFormProps> = ({ onSubmit, isLoading }) => {
  ...
  const [context, setContext] = useState<string>("first meeting, potential partnership");
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <input
                  ...
                  required
                  aria-label="LinkedIn URL or Website"
                />
              </div>
            </div>
